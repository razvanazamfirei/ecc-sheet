...
1. Fetches CSV from Amion API:
   `http://www.amion.com/cgi-bin/ocs?Lo={AMION_SCHEDULE_CODE}`http://www.amion.com/cgi-bin/ocs?Lo=upennane&Rpt=619&Day={day}&Month={month}`Rpt=619`http://www.amion.com/cgi-bin/ocs?Lo=upennane&Rpt=619&Day={day}&Month={month}`Day={day}`http://www.amion.com/cgi-bin/ocs?Lo=upennane&Rpt=619&Day={day}&Month={month}`Month={month}`
